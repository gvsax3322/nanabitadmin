...
const PreparHeader: React.FC<OrAllHeaderProps> = ({ tableNum }) => {
        ...
        >
          <div>
            ...
            <SearchButton
              ...
              onClick={() => handleProcessBtApi([items[0]], 5)}
            >
              주문취소
            </SearchButton>
          </div>
          ...
          <div>
            {products[0].refundFl === 0 && (
              <SearchButton
                ...
                onClick={() => handleProcessBtApi([orderData[1].iorder], 3)}
              >
                배송중
              </SearchButton>
            )}
